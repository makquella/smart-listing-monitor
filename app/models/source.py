...
class Source(Base):
    ...
    last_run_started_at: Mapped[datetime | None] = mapped_column(UTCDateTime())
    last_run_finished_at: Mapped[datetime | None] = mapped_column(UTCDateTime())
    last_successful_run_at: Mapped[datetime | None] = mapped_column(UTCDateTime())
    last_failed_run_at: Mapped[datetime | None] = mapped_column(UTCDateTime())
